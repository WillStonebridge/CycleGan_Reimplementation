...
class Insights():
    ...
    def __init__(self, batches, epochs, name = None):
        ...
        gs = gridspec.GridSpec(2, 6, hspace = 0.8, wspace = 0.3) # subplot_params={'hspace': 0.5, 'wspace': 0.2}
        self.fig = plt.figure(figsize=(8, 4), dpi=190)
    ...
    def update_insights(self, gan, batch, epoch):
        ...
        X, Y, Gx, Gy = self.get_sample(gan) #get images / update losses
    ...
    def instantiateSaveFile(self, args):
        if self.savePath != None:
            ...
            with open(f'{self.savePath}/about.txt', 'w') as f:
                ...
                f.write(f"Basics - {args['lr']} lr, {args['batch']} batches, {args['epochs']} epochs\n")
